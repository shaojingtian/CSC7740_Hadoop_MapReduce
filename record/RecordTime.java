...
public class RecordTime {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "record time");
     ...
     */
    job.setJarByClass(RecordTime.class);
    ...
    /*
     * For the record time application, the mapper's output keys and
     * values have the same data types as the reducer's output keys 
     * and values: Text and Text.
     */
